// 09 Write a function for extracting all email addresses from given text. All substrings that match
...
// The program is not perfect but the idea was not to use regular expressions!