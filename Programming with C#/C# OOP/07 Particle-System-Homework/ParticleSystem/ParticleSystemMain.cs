    ...
    class ParticleSystemMain
    {
        ...
        static void Main(string[] args)
        {
            ...
            var particles = new List<Particle>()
            {
                ...
                //new ParticleAttractor(new MatrixCoords(20, 20), new MatrixCoords(), 1),

                // task 02 -> Test the ChaoticParticle through the ParticleSystemMain class
                // new ChaoticParticle(new MatrixCoords(20, 20), new MatrixCoords(0, 0), RandomGenerator),

                // task 04 -> Test the ChickenParticle class through the ParcticleSystemMain class.
                new ChickenParticle(new MatrixCoords(20, 20), new MatrixCoords(0, 0), RandomGenerator)
            };
